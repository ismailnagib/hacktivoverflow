...
const { show, showOne, showMine, add, edit, remove, search, upvote, downvote, starToggle } = require('../controllers/questionController')
...
router.patch('/star', isLogin, starToggle)
